...
public class Const {
    ...
    public static String PATH_PAGE_NEWCATEGORY = PATH_PRIVATE + "newCategory.jsp";
    public static String PATH_PAGE_NEWCATEGORY_COMPLETE = PATH_PRIVATE + "addCategoryComplete.jsp";
