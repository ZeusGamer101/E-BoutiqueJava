...
public class Item {
    ...
    public Item(int id, int category, int stock, int rating, int nbReview, String name, String description, String serial, String image, String brand, double price, boolean isActive, String categoryName) {
        this.id = id;
        this.category = category;
        this.stock = stock;
        this.rating = rating;
