                    ...
                    <li>
                        ...
                        <form class="navbar-form" role="search" action="items?">
                            <div id="auto-search" class="form-group"  style="padding-right:0;">  
                                <input class="form-control biginput" placeholder="Rechercher" id="autocomplete" type="text" name="search">
                            </div>  
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<%="newProduct"%>">Ajouter un nouveau produit</a></li>
                    <li><a href="<%="listeClients"%>">Afficher les clients</a></li>
                        <%}
                            }%>
                </ul>
